...
public class ProceduralUtil {
    ...
    public static Vector3[] generateRectangleBaseFromVertice(Vector3 center, float width, float length, bool horizontal, float randomOffset)
    {
        ...
        if (!horizontal) {
            ...
            squareBase.Add(new Vector3(center.x - width / 2 + randomOffset, center.y, center.z + length));
            squareBase.Add(new Vector3(center.x + width / 2 + randomOffset, center.y, center.z + length));
            squareBase.Add(new Vector3(center.x + width / 2 + randomOffset, center.y, center.z));
        }
        else {
            squareBase.Add(new Vector3(center.x, center.y - width / 2 + randomOffset, center.z));
            squareBase.Add(new Vector3(center.x, center.y - width / 2 + randomOffset, center.z + length));
            squareBase.Add(new Vector3(center.x, center.y + width / 2 + randomOffset, center.z + length));
            squareBase.Add(new Vector3(center.x, center.y + width / 2 + randomOffset, center.z));
        } 
    ...
    public static Mesh generateBoardOnSide(Box box) {
        ...
        centerVertice = new Vector3(sideBoard.x, sideBoard.y + randomHangingPosY, sideBoard.z + randomHangingPosZ);
    ...
    public static Mesh generateBoardOnRoof(Box box) {
        ...
        Vector3[] rectangleBase = generateRectangleBaseFromVertice(startingVertice, boardLength, width, horizontal, Random.Range(-0.4f, 0.4f));
    ...
    /// </summary>
    public static Mesh combineMeshes(Transform parentTransform, List<Mesh> meshList)
    {
